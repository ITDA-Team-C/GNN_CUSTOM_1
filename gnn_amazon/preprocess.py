#!/usr/bin/env python3
"""
Amazon 데이터 전처리 파이프라인 - .mat 파일 직접 처리
"""
...
from src.preprocessing.load_amazon import load_amazon
...
def save_amazon_data(data_dict, sample_size=10000):
...
def main():
    print("\n" + "="*80)
    print("Amazon 데이터 전처리")
    print("="*80)

    # Step 1: Load
    print("\n[Step 1/2] Amazon 데이터 로드...")
    data_dict = load_amazon()

    # Step 2: Preprocess & Save
    print("\n[Step 2/2] 전처리된 데이터 저장...")
    sampled_labels = save_amazon_data(data_dict)
