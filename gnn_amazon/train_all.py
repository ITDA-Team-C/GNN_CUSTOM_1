"""
Complete training pipeline for all 10 Amazon GNN models
...
def main():
    ...
    for model_name, model in models_config.items():
        ...
        torch.save(model.state_dict(), f"outputs/output_amazon/models/{model_name}.pt")
        print(f"  Test PR-AUC: {metrics['pr_auc']:.4f}, "
              f"ROC-AUC: {metrics['roc_auc']:.4f}, "
              f"Macro-F1: {metrics['macro_f1']:.4f}\n")

    results_path = f"outputs/output_amazon/results/results_{timestamp}.json"
