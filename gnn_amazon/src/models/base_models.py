...
class GCNModel(nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_relations=6, dropout=0.3):
        super().__init__()
...
class SGModel(nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_relations=6, dropout=0.3, K=2):
        super().__init__()
        self.num_relations = num_relations
